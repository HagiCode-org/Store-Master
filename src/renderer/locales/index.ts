  ...
  'en-US': {
    common: {
      ...
      msStore: {
        ...
        saveSuccessDescription: 'The current locale content has been stored in this product workspace.',
        saveFailed: 'Save failed',
        saveFailedDescription: 'Resolve the validation errors and try again.',
        ...
        fillFromLocaleLabel: 'Fill from another language',
        fillFromLocalePlaceholder: 'Choose a source language',
        fillFromLocaleSearch: 'Search source languages',
        fillFromLocaleAction: 'Fill current content',
        fillFromLocaleEmpty: 'No other saved languages are available yet.',
        ...
        languagePanelDescription: 'Switch, add, and remove product-scoped languages directly in this list.',
  ...
  'zh-CN': {
    common: {
      ...
      msStore: {
        ...
        saveAction: '保存记录',
        saveSuccess: '保存成功',
        saveSuccessDescription: '当前语言内容已写入这个产品的工作区。',
        saveFailed: '保存失败',
        saveFailedDescription: '请先修复校验错误后再保存。',
        ...
        creatingNew: '新建语言记录',
        fillFromLocaleLabel: '从其他语言填充',
        fillFromLocalePlaceholder: '选择源语言',
        fillFromLocaleSearch: '搜索源语言',
        fillFromLocaleAction: '填充当前内容',
        fillFromLocaleEmpty: '当前还没有其他已保存语言可供填充。',
        dismissStatus: '关闭',
        ...
        languagePanelDescription: '直接在这里切换、新增和删除当前产品的语言。',

...
const resources = {
  'en-US': {
    common: {
      ...
      msStore: {
        ...
        description: 'Manage locales, market records, and the full Microsoft Store CSV workspace for the active product.',
        ...
        editorDescription: 'Edit {{locale}} content, switch market records, and maintain the full Microsoft CSV workspace.',
        editingExisting: 'Editing market record',
        creatingNew: 'New market record',
        ...
        languagePanelDescription: 'Switch locales first, then review readiness and market coverage.',
        languageStatusReady: 'Ready',
        languageStatusNeedsReview: 'Needs review',
        languageStatusNew: 'New',
        localeRecordsLabel: '{{count}} records',
        localeMarketsLabel: '{{count}} markets',
        overviewTitle: 'Overview',
        overviewDescription: 'Keep locale, market, Store ID, and keywords compact and visible while you edit.',
        marketRecordsTitle: 'Market records',
        marketRecordExisting: 'Existing',
        marketRecordNew: 'New',
        marketRecordsEmpty: 'No market records exist for this locale yet.',
        coverageTitle: 'Coverage',
        coverageRequired: 'Required filled',
        coverageChanged: 'Changed from default',
        coverageLocaleOnly: 'Locale-only fields',
        localeRecordsStat: 'Market records',
        localeMarketsStat: 'Markets',
        localeMarketActive: 'Active market',
  ...
  'zh-CN': {
    common: {
      ...
      msStore: {
        title: 'MS Store 数据维护',
        description: '在当前产品下统一管理语言、市场记录，以及完整的 Microsoft Store CSV 工作区。',
        currentProductLabel: '当前产品',
        ...
        untitledEntry: '未命名记录',
        editorTitle: '语言工作台',
        editorDescription: '编辑 {{locale}} 内容、切换市场记录，并维护完整的 Microsoft CSV 工作区。',
        editingExisting: '编辑已有市场记录',
        creatingNew: '新建市场记录',
        dismissStatus: '关闭',
        ...
        languagePanelDescription: '先切换语言，再查看该语言的就绪状态和市场覆盖。',
        languageStatusReady: '已就绪',
        languageStatusNeedsReview: '待复核',
        languageStatusNew: '新建',
        localeRecordsLabel: '{{count}} 条记录',
        localeMarketsLabel: '{{count}} 个市场',
        overviewTitle: '概览',
        overviewDescription: '把语言、市场、Store ID 和关键词压缩在同一块区域里维护。',
        marketRecordsTitle: '市场记录',
        marketRecordExisting: '已有',
        marketRecordNew: '新建',
        marketRecordsEmpty: '这个语言下还没有任何市场记录。',
        coverageTitle: '覆盖情况',
        coverageRequired: '已填必填项',
        coverageChanged: '相对 default 的改动',
        coverageLocaleOnly: '仅语言列字段',
        localeRecordsStat: '市场记录数',
        localeMarketsStat: '市场数',
        localeMarketActive: '当前市场',
        toolsTitle: '字段工具',

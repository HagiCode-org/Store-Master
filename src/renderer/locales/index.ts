...
const resources = {
  'en-US': {
    common: {
      ...
      msStore: {
        ...
        description: 'Maintain the active product\'s Microsoft Store CSV workspace, including the Partner Center field inventory and product-scoped locale metadata.',
        ...
        editorDescription: 'Edit locale metadata, default-column values, and the full Microsoft CSV field inventory for the active product.',
  ...
  'zh-CN': {
    common: {
      ...
      msStore: {
        title: 'MS Store 数据维护',
        description: '在共享产品上下文中维护当前产品的 Microsoft Store CSV 工作区，包括 Partner Center 全字段和产品级语言记录。',
        currentProductLabel: '当前产品',
        ...
        untitledEntry: '未命名记录',
        editorTitle: '记录编辑器',
        editorDescription: '在当前产品下维护语言记录、default 列值，以及完整的 Microsoft CSV 字段清单。',

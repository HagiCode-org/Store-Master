...
describe('Store Master app shell', () => {
  ...
  it('deletes a locale record from the Product Data language list', async () => {
    vi.mocked(window.storeMaster.readMsStoreData).mockResolvedValueOnce({
      productStorageId: 'prd-11111111-1111-4111-8111-111111111111',
      version: 3,
      entries: [
    ...
    fireEvent.click(screen.getByRole('button', { name: /Delete Chinese \(Simplified\)/ }));
  ...
  it('fills the current locale draft from another saved language before saving', async () => {
    vi.mocked(window.storeMaster.readMsStoreData).mockResolvedValueOnce({
      productStorageId: 'prd-11111111-1111-4111-8111-111111111111',
      version: 3,
      entries: [
    ...
    fireEvent.click(screen.getByRole('button', { name: /Fill current content/i }));
    fireEvent.click(screen.getByRole('button', { name: 'Save record' }));
